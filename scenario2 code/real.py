...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        label = ttk.Label(self, text ="KMap Solver", font = LARGEFONT, background='#23c7d9', foreground="white")
...
class CalcVar(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # label of frame Layout 2
        label = ttk.Label(self, text ="Choose The Amount of Variable Used", font = MIDFONT, background='#23c7d9', foreground="white")
